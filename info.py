...
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", '-1003059886878'))  # Premium user actions log
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1003059886878'))  # Verified user actions log
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1001887592232"))
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", 'Goflix_AdminBot')  # Owner's username
BOT_USERNAME = environ.get("BOT_USERNAME", 'Goflix3bot')  # Bot's username

# 🔗 Channel & Support Links
CHANNEL = environ.get('CHANNEL', 'https://t.me/trendi_Backup')  # Updates channel
SUPPORT = environ.get('SUPPORT', 'https://t.me/Goflix_Disscussion')  # Support group
...
DB_URL = environ.get('DATABASE_URI', "mongodb+srv://harshithacharya633:2g91drYh3nV4GDhW@cluster0.3yqvc4p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB connection URI
DB_NAME = environ.get('DATABASE_NAME', "cluster0")  # MongoDB database name

# 📸 all Media (Images)
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/3zh1hf.jpg')  # QR Code image
VERIFY_IMG = environ.get("VERIFY_IMG", "https://files.catbox.moe/3zh1hf.jpg")  # Verify success image
AUTH_PICS = environ.get('AUTH_PICS', 'https://files.catbox.moe/3zh1hf.jpg')  # Auth step image
PICS = environ.get('PICS', 'https://files.catbox.moe/3zh1hf.jpg')  # Default info image
FILE_PIC = environ.get('FILE_PIC', 'https://files.catbox.moe/3zh1hf.jpg') # file image 
